...
class Safety:
	...
	def safety_actions(self, temps, time):
		...
		for i in nonSafe:
			if i >= 0:
				actions = list(filter(lambda x: x[i - 1] == '2', actions))#TODO CHOOSE THE CORRECT ACTIONS
			else:
				actions2 = []
...
if __name__ == '__main__':
	sft = Safety([[54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0], [54.0, 86.0]])
	print sft.safety_actions([85.6], 0)