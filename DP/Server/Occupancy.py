...
# TODO Do we not want to scale our prediction by how similar the found days were ?
...
class Occupancy:
    def __init__(self, cfg, now=datetime.datetime.utcnow().replace(tzinfo=pytz.timezone("UTC")).astimezone(
        ...
        zone_name = cfg['zone']
        # set entity equal to path of entity given. and the agent to the right ip address.
        c = get_client(agent="127.0.0.1:28589", entity="/Users/Daniel/CIEE/SetUp/ciee_readonly.ent")
        # c = get_client()
